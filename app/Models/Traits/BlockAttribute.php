...
trait BlockAttribute
{
    ...
    {
        return '<a href="'.route('admin.nccne.block.edit', $this).'" class="btn btn-primary"><i class="fas fa-edit" data-toggle="tooltip" data-placement="top"></i></a>';
    }
    ...
    {
        return '<a href="'.route('admin.nccne.block.destroy', $this).'"
			 data-method="delete"
