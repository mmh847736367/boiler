...
@section('title', '你瞅啥文章管理 | 更新文章')

@section('content')
    {{ html()->modelForm($block, 'PATCH', route('admin.nccne.block.update', $block))->class('form-horizontal')->open() }}
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
        ...
        <div class="card-footer">
            <div class="row">
                <div class="col">
                    {{ form_cancel(route('admin.nccne.block.index'), __('buttons.general.cancel')) }}
                </div><!--col-->
